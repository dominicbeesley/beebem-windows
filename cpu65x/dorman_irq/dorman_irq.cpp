// dorman_irq.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
void dointerrupt(uint8_t val) {
	if (ptcpu) {
		ptcpu->execute_set_input(M6502_IRQ_LINE, (val & 0x01) ? ASSERT_LINE : 0);
		ptcpu->execute_set_input(M6502_NMI_LINE, (val & 0x02) ? ASSERT_LINE : 0);
	}
}
...
int main()
{
	...
	ifstream ismos;
	ismos.open(
		"D:\\work\\vs2017\\scratch\\mame-cpu-libs\\mame-cpu-lib-6502-test\\testasm\\dorman\\6502_interrupt_test.bin",
